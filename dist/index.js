...
var WebGLPointsLayer = _interopDefault(require('ol/layer/WebGLPoints'));
...
var CircleStyle = _interopDefault(require('ol/style/Circle'));
...
function VectorLayer(props) {
    ...
    return (React__default.createElement("div", null,
        React__default.createElement(VectorContext.Provider, { value: __assign({}, MapContextValues, { vector: vector.current }) }, props.children)));
}
...
function Tooltip(props) {
    ...
    return (React__default.createElement("div", { ref: tooltipEl },
        React__default.createElement(TooltipContext.Provider, { value: { tooltip: tooltip, show: showTooltip, hide: hideTooltip, id: uuid() } }, props.children)));
}
...
function Popup(props) {
    ...
    return (React__default.createElement("div", { ref: popupEl, className: "ol-popup", style: { display: 'none' } },
        withComponent ? (withComponent(closePopup, openPopup)) : (React__default.createElement(React__default.Fragment, null,
            React__default.createElement("span", { className: "ol-popup-closer", onClick: closePopup }),
            React__default.createElement("div", { className: "pop-content" }, props.content))),
...
function Polygon(props) {
    ...
    var dragInteraction = React.useRef();
    var modifyInteraction = React.useRef();
    var VectorContext = useVectorContext();
    var previousVectorContext = usePrevious(VectorContext);
    React.useEffect(function () {
...
function DrawInteraction(props) {
     ...
     */
    var handleDrawStart = React.useCallback(function (event) {
        if (props.drawingColor) {
     ...
     * @param {DrawEvent} event
     */
    var handleDrawEnd = React.useCallback(function (event) {
